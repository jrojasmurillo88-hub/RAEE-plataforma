...
// Clasificación alineada a la Resolución 0851 de 2022 (taxonomía oficial de AEE/RAEE).
...
export const OBJETOS_COMUNES: ObjetoComun[] = [
  // ── Equipos electrónicos (categoría oficial 2) ──────────────────────────
  { nombre: "Celular", objetoId: "equipos_electronicos" },
  { nombre: "Smartphone", objetoId: "equipos_electronicos" },
  ...
  { nombre: "Pantalla de computador", objetoId: "equipos_electronicos" },
  { nombre: "Impresora", objetoId: "equipos_electronicos" },
  { nombre: "Escáner", objetoId: "equipos_electronicos" },
  { nombre: "Multifuncional", objetoId: "equipos_electronicos" },
  { nombre: "Teclado", objetoId: "equipos_electronicos" },
  { nombre: "Mouse", objetoId: "equipos_electronicos" },
  { nombre: "Disco duro externo", objetoId: "equipos_electronicos" },
  { nombre: "Cargador", objetoId: "equipos_electronicos" },
  { nombre: "Cable USB", objetoId: "equipos_electronicos" },
  { nombre: "Fuente de poder", objetoId: "equipos_electronicos" },
  { nombre: "Router", objetoId: "equipos_electronicos" },
  { nombre: "Módem", objetoId: "equipos_electronicos" },
  { nombre: "Decodificador de TV", objetoId: "equipos_electronicos" },
  { nombre: "Antena parabólica", objetoId: "equipos_electronicos" },
  { nombre: "Consola de videojuegos", objetoId: "equipos_electronicos" },
  { nombre: "Cámara fotográfica", objetoId: "equipos_electronicos" },
  { nombre: "Cámara de video", objetoId: "equipos_electronicos" },
  { nombre: "Audífonos", objetoId: "equipos_electronicos" },
  { nombre: "Audífonos inalámbricos", objetoId: "equipos_electronicos" },
  { nombre: "Smartwatch", objetoId: "equipos_electronicos" },
  { nombre: "Reloj inteligente", objetoId: "equipos_electronicos" },
  { nombre: "Calculadora", objetoId: "equipos_electronicos" },
  { nombre: "Tensiómetro digital", objetoId: "equipos_electronicos" },
  { nombre: "Glucómetro digital", objetoId: "equipos_electronicos" },
  ...
  { nombre: "Theatre en casa", objetoId: "equipos_electronicos" },
  ...
  // ── Electrodomésticos pequeños (categoría oficial 1, enseres menores) ──
  ...
  { nombre: "Manta eléctrica", objetoId: "electrodomesticos_pequenos" },
  { nombre: "Deshidratador de frutas", objetoId: "electrodomesticos_pequenos" },
  { nombre: "Microondas", objetoId: "electrodomesticos_pequenos" },
  { nombre: "Lavaplatos eléctrico", objetoId: "electrodomesticos_pequenos" },
  { nombre: "Lavavajillas", objetoId: "electrodomesticos_pequenos" },
  ...
  { nombre: "Cepillo dental eléctrico", objetoId: "electrodomesticos_pequenos" },
  ...
  { nombre: "Extractor de olores", objetoId: "electrodomesticos_pequenos" },
  ...
  // ── Electrodomésticos grandes (categoría oficial 1, enseres mayores —
  //    incluye "Enseres de audio y video": TV, radio, equipo de sonido) ───
  ...
  { nombre: "Refrigerador", objetoId: "electrodomesticos_grandes" },
  { nombre: "Congelador", objetoId: "electrodomesticos_grandes" },
  { nombre: "Vinera eléctrica", objetoId: "electrodomesticos_grandes" },
  ...
  // ── Bombillos y luminarias (categoría oficial 3) ────────────────────────
  { nombre: "Bombillo", objetoId: "bombillos" },
  { nombre: "Bombilla", objetoId: "bombillos" },
  { nombre: "Lámpara de mesa", objetoId: "bombillos" },
  { nombre: "Lámpara de techo", objetoId: "bombillos" },
  { nombre: "Tubo fluorescente", objetoId: "bombillos" },
  { nombre: "Foco LED", objetoId: "bombillos" },
  { nombre: "Luminaria", objetoId: "bombillos" },
  { nombre: "Balasto", objetoId: "bombillos" },

  // ── Pilas y baterías (categoría oficial 3) ──────────────────────────────
  ...
  { nombre: "Power bank", objetoId: "pilas" },
  { nombre: "Batería externa", objetoId: "pilas" },
  { nombre: "Batería de portátil", objetoId: "pilas" },
  { nombre: "Batería de celular", objetoId: "pilas" },

  // ── Baterías de carro (régimen aparte — Resolución 372 de 2009, no RAEE) ─
